...
//        override val name: String
    ...
    companion object CREATOR : Parcelable.Creator<ImperialSimpleFutureWeatherEntry> {
        override fun createFromParcel(parcel: Parcel): ImperialSimpleFutureWeatherEntry {
            return ImperialSimpleFutureWeatherEntry(parcel)
        }

        override fun newArray(size: Int): Array<ImperialSimpleFutureWeatherEntry?> {
